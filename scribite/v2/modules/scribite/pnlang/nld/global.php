<?php
// File: $Id: global.php 454 2007-08-16 09:09:36Z teb $
// ----------------------------------------------------------------------
...
// Translation team: Dutch PostNuke Community - http://postnuke.opencms.nl/
// Translation: Teb (Arjen Tebbenhof)
// version 2.1
// ----------------------------------------------------------------------

// common
define('_EDITOR', 'Scribite!');
define('_EDITORINFO', 'WYSIWYG voor Postnuke CMS');
...
define('_EDITORUPDATED', 'Configuratie bijgewerkt');
define('_EDITORSPATH', 'Editorpad');
define('_JSWARNING', 'Folder /modules/scribite/pnincludes is niet meer in gebruik en dient verwijderd te worden!');
define('_ADDMOD', 'module toevoegen');
define('_EDITMOD', 'module bewerken');
...
define('_XINHABARMODE0', 'volledig');
...
define('_TINYMCETIMEFORMAT', 'Tijd formaat');
define('_TINYMCEWINDOW', 'Editorbreedte en -hoogte');
...
define('_FCKEDITORWINDOW', 'Editorbreedte en -hoogte');
