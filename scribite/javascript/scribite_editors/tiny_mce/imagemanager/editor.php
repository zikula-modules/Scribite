...
<div id="tools">
	...
	<div id="tools_save" style="display:none;">
		...
		<a href="javascript: editor.doSubmit('save');window.opener.parent.location.reload();parent.close();" class="buttons" title="OK"><img src="img/btn_ok.gif" height="30" width="30" alt="OK" /></a>
		<a href="javascript: editor.reset();" class="buttons" title="Cancel"><img src="img/btn_cancel.gif" height="30" width="30" alt="Cancel" /></a>		
	</div>	
</div>
<div id="toolbar">
