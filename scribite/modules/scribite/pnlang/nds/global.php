...
define('_JSWARNING', 'De Orner /modules/scribite/pnincludes is nich n�dig un kann l�scht weern!');
define('_ADDMOD', 'Modul tov�gen');
...
define('_MODFUNCS', 'Modulfunkschoon (kommascheden, "all" f�r all Funkschoonen)');
define('_MODAREAS', 'Textarea-ID\'s (kommascheden, "all" f�r all Textareas)');
define('_MODEDITOR', 'Editor');
define('_WARNING', 'Wohrschau');
define('_JSQACTIVATED', 'JS Quick Tags s�nt aktiv.<br />F�r een s�ver Funkschoon schull dat deaktiviert weern in de Zikula Instellen ');
...
define('_XINHALANGUAGE', 'Editorspraak');
define('_XINHASKIN', 'Utsehn');
define('_XINHABARMODE', 'Symbolliest');
define('_XINHABARMODE0', 'vull');
define('_XINHABARMODE1', 'reduziert');
define('_XINHABARMODE2', 'mini');
define('_XINHAWINDOW', 'Editorbredde un -h��cht');
define('_XINHASTATUSBAR', 'Statusbar');
define('_XINHASTYLE', 'Editor-Stylesheet');
define('_XINHACONVERTURLS', 'Urls in Links �mmodeln');
...
define('_OPENWYSIWYGWINDOW', 'Editorbredde un -h��cht');
...
define('_YUIWINDOW', 'Editorbredde un -h��cht');
