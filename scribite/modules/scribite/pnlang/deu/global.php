...
define('_EDITORINFO', 'WYSIWYG f�r Zikula');
...
define('_JSWARNING', 'Der Ordner /modules/scribite/pnincludes ist nicht mehr n�tig und kann gel�scht werden!');
define('_ADDMOD', 'Modul hinzuf�gen');
define('_EDITMOD', 'Modul bearbeiten');
define('_DELMOD', 'Modul l�schen');
define('_DELMODQUESTION', 'Soll das Modul wirklich gel�scht werden?');
define('_MODNAME', 'Modulname');
define('_MODFUNCS', 'Modulfunktionen (kommasepariert, "all" f�r alle Funktionen)');
define('_MODAREAS', 'Textarea-ID\'s (kommasepariert, "all" f�r alle Textareas)');
define('_MODEDITOR', 'Editor');
define('_WARNING', 'Warnung');
define('_JSQACTIVATED', 'JS Quick Tags sind aktiviert.<br />F�r eine einwandfreie Funktion sollte dies in den Zikula Einstellungen deaktiviert werden');
define('_DEFAULTEDITOR', 'Standardeditor');
// v3.x
define('_ERRORCREATINGHOOK', 'Hook konnte nicht erstellt werden!');
define('_HOOKHINT', '<strong>scribite!</strong> wurde als Core-Hook aktiviert. Die Einstellungen k�nnen <a href="index.php?module=Modules&type=admin&func=hooks&id=0">hier</a> �berpr�ft werden!<br />Das Template-Plugin von �lteren scribite!-Versionen kann aus den Templates entfernt werden.');
define('_VERSIONHINT', 'Diese Version von scribite! arbeitet nur mit Zikula 1.1.x und h�her. Bitte ein Upgrade durchf�hren oder scribite! in Version 2.x benutzen.');
...
define('_XINHAWINDOW', 'Editorbreite und -h�he');
...
define('_TINYMCEWINDOW', 'Editorbreite und -h�he');
...
define('_FCKEDITORWINDOW', 'Editorbreite und -h�he');
...
define('_OPENWYSIWYGWINDOW', 'Editorbreite und -h�he');
...
define('_YUIWINDOW', 'Editorbreite und -h�he');
