{adminheader}
{gt text='TinyMCE configuration' assign='templateTitle'}
...
{form cssClass='z-form'}
    ...
    <fieldset>
        <legend>{gt text='TinyMCE Plugins (<a href="https://www.tinymce.com/docs/plugins/" title="TinyMCE plugins">documentation</a>)'}</legend>
        <div class="z-formrow">
