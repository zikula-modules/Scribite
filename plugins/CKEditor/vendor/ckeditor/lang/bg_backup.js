...
CKEDITOR.lang['bg'] = {
    ...
    "common": {
        ...
        "alignTop": "Горе",
        "alignMiddle": "Подравни в средата",
        "alignBottom": "Долу",
        "alignNone": "Без подравняване",
        "invalidValue": "Невалидна стойност.",
        "invalidHeight": "Височината трябва да е число.",
        "invalidWidth": "Ширината трябва да е число.",
		"invalidLength": "Стойността на полето \"%1\", трябва да бъде положително число с или без валидна мерна единица (%2).",
    ...
    "btgrid": {
        "selNumCols": "Изберете брой колони",
        "genNrRows": "Брой редове",
        "infoTab": "Информация",
        "createBtGrid": "Създай Bootstrap мрежа",
        "editBtGrid": "Редакция на Bootstrap мрежа",
        "numColsError": "Моля изберете брой колони.",
        "numRowsError": "Моля въведете цифрова стойност за брой редове."
    },
    "colordialog": {
        "clear": "Изчистване",
    ...
    "wordcount": {
        ...
        "CharCount": "Знаци:",
        "CharCountRemaining": "Оставащи знаци",
