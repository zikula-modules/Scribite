...
*/
CKEDITOR.plugins.setLang( 'imageplus', 'bg', {
    ...
    linkCopyImageUrl: 'Копирай от изображението',
    base64src: 'Вмъква изображението директно като низ',
    browseLocal: 'Избор локален'
} );
