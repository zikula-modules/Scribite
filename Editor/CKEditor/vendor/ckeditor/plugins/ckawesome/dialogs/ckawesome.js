...
CKEDITOR.dialog.add('ckawesomeDialog', function( editor ) {
    ...
    return {
        title: CKEDITOR.config.language == 'bg' ? 'Вмъкни икона Awesome' : 'Insert CKAwesome',
        minWidth: 200,
        minHeight: 200,
        ...
        contents: [
            {
                id: 'options',
                label: CKEDITOR.config.language == 'bg' ? 'Настройки' : 'Basic Settings',
                elements: [
                    {
					    type: 'select',
					    id: 'ckawesomebox',
					    label: CKEDITOR.config.language == 'bg' ? 'Изберете от шрифт Awesome' : 'Select font Awesome',
					    validate: CKEDITOR.dialog.validate.notEmpty( CKEDITOR.config.language == 'bg' ? "Полето за избор  не може да бъде празно." : "Font Awesome field cannot be empty." ),
                    ...
                    },
                    {
                        type: 'select',
                        id: 'textsize',
                        label: CKEDITOR.config.language == 'bg' ? 'Изберете размер' : 'Select size',
                        items: [[ editor.lang.common.notSet, '' ]],
                        ...
                        children: [
                            {
                                id: 'fontcolor',
                                type: 'text',
                                label: CKEDITOR.config.language == 'bg' ? 'Изберете цвят' : 'Select color',
                            ...
                            },
                            {
                                ...
                                id: "fontcolorChooser",
                                "class": "colorChooser",
                                label: CKEDITOR.config.language == 'bg' ? 'Цвят' : "Color",
