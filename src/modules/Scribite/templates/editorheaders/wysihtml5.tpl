...
{pageaddvar name="javascript" value="modules/Scribite/plugins/Wysihtml5/javascript/wysihtml5-0.3.0.min.js"}
{pageaddvar name="javascript" value="modules/Scribite/plugins/Wysihtml5/javascript/parser_rules/simple.js"}
...
<script type="text/javascript">
    ...
    function addWysihtml5(textareaName) {
        ...
        toolbar.innerHTML = '{{include file="editorheaders/wysihtml5/toolbar.tpl"}}';
