...
/* <![CDATA[ */
   ...
   ********************************************************************/
    ...
    full.ImagesDir = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/images/";
    full.PopupsDir = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/popups/";
    full.CSSFile = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/styles/wysiwyg.css";
    ...
    full.ImagePopupFile = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/addons/imagelibrary/insert_image.php";
    full.ImagePopupWidth = 600;
    full.ImagePopupHeight = 245;

    var reduced = new WYSIWYG.Settings();
    reduced.ImagesDir = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/images/";
    reduced.PopupsDir = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/popups/";
    reduced.CSSFile = "<!--[$postnukeBaseURL]-->/<!--[$editors_path]-->/<!--[$editor_dir]-->/styles/wysiwyg.css";
